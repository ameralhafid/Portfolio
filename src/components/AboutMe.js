    ...
    <div id="about" className="container py-5">
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
            Hello! I am Amer. I have been developing websites for 1 year. I'm software Engineering student in the last semester.
            Technologies I use is (MongoDB, GraphQL, RestAPI, ReactJS and NodeJS).
            ...
            After the website is finished and ready to deploy and sell a product or service. It is essential that your potential clients know about you. I will create an advertising campaign for you in  Google Ads, Facebook and Instagram!
          </p>
        </div>
      </div>
    </div>
